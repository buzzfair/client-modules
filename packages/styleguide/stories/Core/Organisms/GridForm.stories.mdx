      ...
      fields={[
        {
          ...
          description: 'Does this default get reset',
          name: 'has-default',
          size: 4,
          type: 'text',
        },
        {
          description: 'Validation: must equal "swag"',
          name: 'has-validation',
          size: 4,
          type: 'text',
          validation: {
            validate: (value) => value === 'swag' || 'Must be swag',
          },
        },
      ]}
...
#### Submit with no label text (but label still rendered) does not align properly with the checkbox
...
#### Submit even when the label has visible text, is still not aligned right

<Preview>
  <Story name="No Label Inline">
    <GridForm
      fields={[
        {
          label: 'Label',
